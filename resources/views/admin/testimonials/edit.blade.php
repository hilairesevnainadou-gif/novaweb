...
@section('title', 'Modifier le témoignage - NovaTech Admin')
...
<div class="admin-card" data-aos="fade-up">
    ...
    <div class="card-body-custom">
        ...
        <form method="POST" action="{{ route('admin.testimonials.update', $testimonial) }}" enctype="multipart/form-data" id="testimonialForm">
            @csrf
            @method('PUT')
                    ...
                    <div class="col-12">
                        <div class="form-group-camille">
                            ...
                            <div class="form-help">
                                ...
                                Un témoignage authentique et détaillé inspire plus confiance.
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="rating-container" id="ratingContainer">
                                ...
                                <label class="star-option" data-rating="0">
                                    <input type="radio"
                                           name="rating"
                                           value="0"
                                           {{ old('rating', $testimonial->rating) == 0 ? 'checked' : '' }}>
                        ...
                        <div class="form-group-camille">
                            ...
                            @if($testimonial->avatar)
                                <div class="current-avatar" id="currentAvatar">
                                    <img src="{{ asset('storage/' . $testimonial->avatar) }}" class="current-avatar-img" alt="Avatar actuel">
                                    <span class="small">Avatar actuel</span>
                                    <button type="button" id="deleteExistingAvatar" class="btn-camille-outline" style="padding: 0.25rem 0.5rem; font-size: 0.7rem;">
                        ...
                        <div class="form-group-camille">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="is_active">
                                    Activer le témoignage
                                </label>
                            </div>
                            <div class="form-help">Décoché = non visible sur le site</div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="recap-box">
                            ...
                            <div class="recap-item">
                                ...
                                <div class="recap-value" id="recapName">{{ $testimonial->name }}</div>
                            </div>
                            <div class="recap-item">
                                <div class="recap-label">Poste :</div>
                                <div class="recap-value" id="recapPosition">{{ $testimonial->position ?? '-' }}</div>
                            </div>
                            <div class="recap-item">
                                <div class="recap-label">Entreprise :</div>
                                <div class="recap-value" id="recapCompany">{{ $testimonial->company ?? '-' }}</div>
                            </div>
                            <div class="recap-item">
                                <div class="recap-label">Note :</div>
                                <div class="recap-value" id="recapRating">
                            ...
                            <div class="recap-item">
                                ...
                                <div class="recap-value" id="recapContent">{{ Str::limit($testimonial->content, 150) }}</div>
                            </div>
                        </div>
...
<script>
    ...
    if (removeImageBtn) {
        removeImageBtn.addEventListener('click', function() {
            ...
            previewImg.src = '';
            if (currentAvatar) currentAvatar.style.display = 'flex';
            if (deleteAvatarInput) deleteAvatarInput.value = '0';
        });
    }

    // Supprimer l'avatar existant
    const deleteExistingAvatarBtn = document.getElementById('deleteExistingAvatar');
    if (deleteExistingAvatarBtn) {
        deleteExistingAvatarBtn.addEventListener('click', function() {
