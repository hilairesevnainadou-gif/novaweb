...
@section('title', 'Modifier le membre - NovaTech Admin')
            ...
            <div class="step-panel active" id="panel-1">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <!-- Photo actuelle -->
                        @if($teamMember->photo)
                        <div class="image-preview" id="existingPhotoPreview">
                            <img src="{{ asset('storage/' . $teamMember->photo) }}" alt="Photo actuelle">
                            <div class="preview-info">
                                <div class="preview-name">Photo actuelle</div>
                                <span class="form-help">{{ basename($teamMember->photo) }}</span>
                            </div>
                            <button type="button" class="btn-remove-img" data-preview="existingPhotoPreview" data-remove-photo="1">
                                <i class="fas fa-trash-alt"></i>
                            </button>
                        </div>
                        @endif

                        <div id="newPhotoPreview" style="display: none;"></div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <textarea id="bio" name="bio" rows="4"
                                      ...
                                      placeholder="Parcours, expériences, passions…">{{ old('bio', $teamMember->bio) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="quote" name="quote" rows="2"
                                      ...
                                      placeholder="Une citation inspirante…">{{ old('quote', $teamMember->quote) }}</textarea>
                    ...
                    <div class="form-grid form-grid-2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" id="github" name="github"
                                   ...
                                   value="{{ old('github', $teamMember->github) }}"
...
(function () {
    ...
    // Après une soumission avec erreurs : détecter si l'erreur concerne l'étape 2
    @if($errors->any())
    (function() {
    ...
    @if(isset($teamMember) && !empty($teamMember->skills))
        skills = @json($teamMember->skills);
    @elseif(old('skills'))
    ...
    function renderSkills() {
        ...
        // Inputs cachés skills[] pour Laravel
    ...
    document.querySelectorAll('.btn-remove-img').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            // Si c'est la photo existante, ajouter un champ pour indiquer la suppression
            if (this.dataset.removePhoto === '1') {
                ...
                if (!removeField) {
                    ...
                    removeField.value = '1';
                    document.getElementById('teamForm').appendChild(removeField);
                }
            }
        });
    });
    ...
    photoInput?.addEventListener('change', function () {
        ...
        reader.onload = function (ev) {
            ...
            newPhotoPreview.innerHTML = `
                <div class="image-preview" id="newPhotoPreviewImg">
                    ...
                    <button type="button" class="btn-remove-img" onclick="removeNewPhoto()">
                        <i class="fas fa-trash-alt"></i>
                    </button>
                </div>
            `;
