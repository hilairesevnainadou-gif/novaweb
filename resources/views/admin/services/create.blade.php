...
@section('title', 'Nouveau service - NovaTech Admin')
...
<style>
    ...
    /* Sélecteur d'icônes amélioré - GRILLE RESPONSIVE */
    .icon-select-wrapper {
        position: relative;
    }
    ...
    /* Scrollbar personnalisée pour la grille d'icônes */
...
<div class="admin-card" data-aos="fade-up">
    <div class="card-header-custom">
        <h2><i class="fas fa-plus-circle"></i> Créer un nouveau service</h2>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group-camille">
                            ...
                            <textarea id="description"
                                      ...
                                      rows="3"
                                      maxlength="500"
                                      placeholder="Brève description du service (apparaît dans les listes)...">{{ old('description') }}</textarea>
                    ...
                    <div class="col-6">
                        <div class="form-group-camille">
                            ...
                            <div class="icon-grid" id="iconGrid">
                                ...
                                <div class="icon-option" data-icon="{{ $iconKey }}">
                    ...
                    <div class="col-6">
                        <div class="form-group-camille">
                            ...
                            <input type="hidden" id="icon_color" name="icon_color" value="{{ old('icon_color') }}">
                            <div class="color-options" id="colorOptions">
                                ...
                                @endphp
                                <div class="color-option" data-color="{{ $colorKey }}">
                        ...
                        <div class="icon-color-preview">
                            ...
                            <div class="preview-card" id="livePreview">
                                ...
                                <div class="preview-info">
                                    <div class="preview-title" id="previewTitle">Titre du service</div>
                                    <div class="preview-text" id="previewDescription">Description courte du service...</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="form-group-camille">
                            ...
                            <textarea id="full_description"
                                      ...
                                      rows="12"
                                      placeholder="Description détaillée du service...">{{ old('full_description') }}</textarea>
...
<script>
    ...
    iconOptions.forEach(option => {
        option.addEventListener('click', function() {
            ...
            // Mettre à jour la couleur de l'aperçu si une couleur est déjà sélectionnée
        ...
        if (iconInput.value && option.dataset.icon === iconInput.value) {
            option.classList.add('selected');
            if (previewIcon) {
                previewIcon.className = `fas fa-${iconInput.value}`;
            }
        }
    });
    ...
    colorOptionsList.forEach(option => {
        ...
        if (colorInput.value && option.dataset.color === colorInput.value) {
            option.classList.add('selected');
            const bgColor = colorMapPreview[colorInput.value] || '#6366f1';
            if (previewIconContainer) {
                previewIconContainer.style.background = `${bgColor}20`;
                previewIconContainer.style.color = bgColor;
            }
