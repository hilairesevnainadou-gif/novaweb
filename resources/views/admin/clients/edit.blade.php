...
@section('title', 'Modifier le client - NovaTech Admin')
    ...
    <div class="card-body">
        ...
        <form method="POST"
            ...
            <div class="type-selector">
                <div class="type-btn {{ old('client_type', $client->client_type) == 'company' ? 'active' : '' }}" data-type="company">
                ...
                <div class="type-btn {{ old('client_type', $client->client_type) == 'individual' ? 'active' : '' }}" data-type="individual">
            ...
            <div id="companyFields"
                 class="form-section company-fields {{ old('client_type', $client->client_type) == 'company' ? '' : 'hidden' }}">
            ...
            <div class="form-section">
                ...
                <div class="services-grid">
                    ...
                    <div class="service-checkbox">
                        <input type="checkbox"
                               ...
                               value="{{ $service->id }}"
                               {{ in_array($service->id, $clientServices ?? []) ? 'checked' : '' }}>
                ...
                <div class="form-help" style="margin-top: 0.75rem;">
                    <i class="fas fa-info-circle"></i> Les services sélectionnés seront associés à ce client
                </div>
            </div>
            @endif
                ...
                <div class="form-grid form-grid-3">
                    <div class="form-group">
                        ...
                        <select id="billing_cycle" name="billing_cycle"
                            ...
                            <option value="monthly"   {{ old('billing_cycle', $client->billing_cycle) == 'monthly'   ? 'selected' : '' }}>Mensuel</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="toggle-group">
                            <input type="checkbox"
                                   ...
                                   value="1"
                                   {{ old('invoice_by_email', $client->invoice_by_email) ? 'checked' : '' }}>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    <label class="form-label">
                        ...
                        <span id="logoLabelText">{{ $client->client_type == 'company' ? 'Logo de l\'entreprise' : 'Photo / Avatar' }}</span>
                    </label>
                    <div class="upload-area" onclick="document.getElementById('logoInput').click()">
                        <i class="fas fa-cloud-upload-alt"></i>
                        <p id="uploadText">{{ $client->client_type == 'company' ? 'Cliquez pour télécharger le logo' : 'Cliquez pour télécharger une photo' }}</p>
            ...
            <div class="form-footer">
                <a href="{{ route('admin.clients.show', $client) }}" class="btn btn-ghost">
...
(function () {
    ...
    function setClientType(type) {
        ...
        const logoText = isCompany ? 'Logo de l\'entreprise' : 'Photo / Avatar';
        logoLabelText.textContent = logoText;
        if (logoSectionTitle) logoSectionTitle.textContent = logoText;
