...
<div class="card">
    ...
    <div class="header">
        ...
        <div class="subtitle">Invitation à rejoindre la plateforme</div>
    ...
    <div class="body">
        ...
        <p>Vous avez été invité(e) à rejoindre <strong>{{ config('app.name') }}</strong>. Cliquez sur le bouton ci-dessous pour activer votre compte et choisir votre mot de passe.</p>
        ...
        <p>Si vous n'attendiez pas cette invitation, ignorez simplement cet email.</p>
