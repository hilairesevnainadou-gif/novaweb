        ...
        <div class="email-wrapper">
            ...
            <div class="content">
                ...
                <div class="confirmation-message">
                    Nous vous confirmons la reception de votre paiement.
                </div>

                <div class="info-box">
                    <div class="info-row">
                        <span class="info-label">Numero du reçu</span>
                    ...
                    @if($payment->invoice)
                    <div class="info-row">
                        <span class="info-label">Facture associee</span>
                ...
                <div class="text-center mt-4">
                    <a href="{{ route('admin.billing.payments.show', $payment) }}" class="button">
                        Voir le recu en ligne
                    </a>
                </div>
