...
<title>Réinitialisation | Nova Tech</title>
...
<div class="layout">
    ...
    <div class="left">
        ...
        <div class="logo-wrap">
            ...
            <span class="logo-name">Nova Tech</span>
        </div>
        ...
        <h1 class="headline">
            <span class="line-1">Sécurisez votre</span>
            <span class="line-2">compte en toute simplicité</span>
        </h1>

        <p class="subtext">
            Nova Tech protège vos données avec les meilleures technologies de chiffrement. Réinitialisez votre mot de passe en toute sécurité.
        </p>
        ...
        <div class="features">
            <div class="feature-item">
                ...
                <div class="feature-text">
                    <div class="ft-title">Chiffrement de bout en bout</div>
                    <div class="ft-desc">Vos données sont protégées à chaque étape</div>
                </div>
            </div>
            <div class="feature-item">
                <div class="feature-icon"><i class="fas fa-key"></i></div>
                <div class="feature-text">
                    <div class="ft-title">Réinitialisation sécurisée</div>
                    <div class="ft-desc">Processus vérifié et authentifié</div>
                </div>
            </div>
            <div class="feature-item">
                <div class="feature-icon"><i class="fas fa-clock"></i></div>
                <div class="feature-text">
                    <div class="ft-title">Lien temporaire</div>
                    <div class="ft-desc">Valable 60 minutes pour votre sécurité</div>
                </div>
            </div>
        </div>
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="input-group">
                    ...
                    <input
                        ...
                        required
                    >
                    <button type="button" class="toggle-pw" id="togglePwConfirm" aria-label="Afficher le mot de passe">
                        <i class="fas fa-eye" id="eyeIconConfirm"></i>
                    </button>
                </div>

                <button type="submit" class="btn-submit" id="submitBtn">
                    Réinitialiser le mot de passe <i class="fas fa-arrow-right btn-icon"></i>
                </button>
...
<script>
(function() {
    // Toggle password pour le champ mot de passe
    ...
    // Toggle password pour la confirmation
    const btnConfirm = document.getElementById('togglePwConfirm');
    ...
    if (btnConfirm && inputConfirm && iconConfirm) {
        btnConfirm.addEventListener('click', function() {
            const isHidden = inputConfirm.type === 'password';
            inputConfirm.type = isHidden ? 'text' : 'password';
            iconConfirm.className = isHidden ? 'fas fa-eye-slash' : 'fas fa-eye';
        });
    }
