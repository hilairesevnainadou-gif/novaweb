...
<title>Inscription | Nova Tech</title>
    ...
    <div class="right">
        <div class="card">
            <div class="card-header">
                ...
                <p>Rejoignez Nova Tech et transformez votre vision digitale en réalité.</p>
            </div>
            @if($errors->any())
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <label class="field-label" for="password_confirmation" style="margin-top: 16px;">Confirmer le mot de passe</label>
                <div class="input-group" style="margin-bottom:20px;">
                    <i class="fas fa-lock input-icon"></i>
                    <input
                ...
                <button type="submit" class="btn-submit" id="submitBtn">
                    Créer mon compte <i class="fas fa-arrow-right btn-icon"></i>
                </button>
